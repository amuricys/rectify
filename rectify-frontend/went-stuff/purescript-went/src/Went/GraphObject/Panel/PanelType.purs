...
import GoJS.GraphObject.Types (class IsGraphObject, class IsNode, class IsPanel, class IsPart)
...
instance IsPart pa => IsPart (PanelTypeTag p pa) where
  fromPart = unsafeCoerce
instance IsNode n => IsNode (PanelTypeTag p n) where
