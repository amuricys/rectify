module Went.GraphObject.Panel.Fields.Pure where
...
type PanelPureFields :: Row Type -> Row Type
type PanelPureFields r =
...
type PanelFields (r :: Row Type) = GraphObjectPureFields Panel_ (PanelPureFields r)
